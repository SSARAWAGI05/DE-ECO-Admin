          ...
          <div className="bg-white dark:bg-neutral-900 rounded-t-2xl sm:rounded-2xl w-full max-w-xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto shadow-2xl border border-slate-200 dark:border-neutral-800 dark:border-neutral-700">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full bg-slate-900 dark:bg-white hover:bg-slate-800 dark:hover:bg-slate-200 text-white dark:text-slate-900 py-4 rounded-lg font-bold text-base transition-colors"
                >
          ...
          >
            <div className="flex gap-4 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-lg text-slate-900 dark:text-slate-50 mb-1.5 truncate" title={r.title}>{r.title}</h3>
